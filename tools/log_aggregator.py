...
class LogAggregator:
    ...
    def export_csv(self, output_path -> None: str, max_entries -> None: int = 10000) -> None:
    ...
    def export_json(self, output_path -> None: str) -> None:
    ...
    def generate_html_report(self, output_path -> None: str) -> None:
        summary = self.get_summary()
        html = f"""<!DOCTYPE html>
<html lang="en">
